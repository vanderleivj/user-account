          ...
          <div className="text-center">
            ...
            {/* <div className="space-y-4">
              ...
              <div className="flex flex-col gap-3">
                ...
                <a
                  href="https://play.google.com/store/apps/details?id=com.santoencontro.app"
                  target="_blank"
                  rel="noopener noreferrer"
            ...
            <div className="mt-6 pt-4 border-t border-green-200">
              <button
                ...
                className="bg-gray-500 text-white px-6 py-2 rounded-full hover:bg-gray-600 transition-colors text-sm"
              >
                Voltar ao Início
              </button>
            </div>
